...
I=0
FILENAME1="flesnet11.cfg"
FILENAME2="flesnet22.cfg"
...
if [ "1" -eq "$MULTI" ]; then
	...
	FILE1=$FILENAME1 FILE2=$FILENAME2 MULTI=$MULTI COMPUTE=$COMPUTE INPUT=$INPUT SRUN=0 JOB_ID=$MOAB_JOBID HUGE_PAGES=$HUGE_PAGES aprun -N2 -n$PES_PER_NODE -F exclusive -d 5 -cc depth ./flesnetRunMulti1.sh
fi
wait
